...
├── tool_formViewer.html           # Form.io form viewer
├── tool_reportViewer.html         # DevExpress report viewer
├── tool_printoutFromForm.html     # Printout generator
├── tool_tableFromForm.html        # SQL table generator
├── tool_formFromTable.html        # Form.io JSON generator
├── tool_codeFormatter.html        # Code formatting utility
├── guidCheatSheet.html            # GUID reference guide
├── patchNotes.html                # Version history and updates
├── README.md                      # This file
│
├── components/                    # Reusable HTML components
│   ├── comp_navbar.html           # Navigation bar component
│   ├── comp_devexpress-viewer.html # DevExpress preview component
│   └── comp_formio-viewer.html    # Form.io preview component
│
├── scripts/
│   ├── scripts.js                 # Shared utility functions
│   └── Tools/
│       ├── CodeFormatter/
│       │   └── tool_codeFormatter.js
│       ├── FormFromTable/
│       │   └── tool_formFromTable.js
│       ├── FormViewer/
│       │   ├── form-viewer.js
│       │   └── renderFormio.js
│       ├── PrintoutFromForm/
│       │   ├── tool_printoutFromForm.js
│       │   ├── componentCleaner.js
│       │   ├── componentProcessor.js
│       │   ├── devexpress-definitions.js
│       │   ├── layoutConfig.js
│       │   ├── xmlProcessor.js
│       │   └── xmlValidator.js
│       ├── ReportViewer/
│       │   └── tool_reportViewer.js
│       └── TableFromForm/
│           └── tool_tableFromForm.js
│
├── styles/
│   ├── style.css                  # Global styles
│   └── reportViewer.css           # Report viewer specific styles
│
├── img/                           # Images and icons
│
├── Examples/                      # Example files
│   ├── devexpress/               # DevExpress XML/JSON examples
│   ├── formio/                   # Form.io JSON examples
